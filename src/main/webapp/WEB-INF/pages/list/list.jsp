        ...
        <section class="Fsl">
            <ul>
                ...
                <c:forEach items="${productList}" var="productList" varStatus="status">
                        <li>
                            <a href="/toDetail?id=${productList.id}"  title="菜名"><img src="${ctx}${productList.imageUrl}"></a>
                            ...
                            <p>
                                <span class="DSBUTTON" style="float: right"><a href="/toDetail?id=${productList.id}"  class="Fontfff">商品详情</a></span>
                            </p>
                        </li>
                </c:forEach>
            </ul>
            ...
            <aside>
                ...
                <c:forEach items="${HotProductList}" var="HotProductList" varStatus="status">
                    <div class="C-list">
                        <a href="/toDetail?id=${HotProductList.id}" title="菜名"><img src="${ctx}${HotProductList.imageUrl}" width="100%" height="30%"></a>
                        <p><a href="/toDetail?id=${HotProductList.id}" >${HotProductList.productName}</a></p>
                        <p>
            ...
            <div class="TurnPage">
                ...
                <a href="findProductByCategory?page=${pages.navigateFirstPage}&">
                ...
                <a href="findProductByCategory?page=${pages.navigateLastPage}">
